...
- all user specific data will be retrieved from sheets when logging .
...
- for info over the speadsheet layout look at [`./info and rules/spreadsheet layout.md`](../info%20and%20rules/spreadsheet%20layout.md).
### info

###### this is what it is used for and why.

- the site will be hosted on a server that only has RAM and no SSD.
